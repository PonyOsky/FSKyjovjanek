    ...
    <body class="bg">
        <header style="background-color: #ffff;">
            <nav class="navbar navbar-expand-lg">
                ...
                <button class="navbar-toggler colapsed blue" type="button" data-bs-toggle="collapse" data-bs-target="#Burger" style="margin-right: 3%">
        ...
        <footer class="bgBlue" style="position: fixed; left: 0; bottom: 0; width: 100%;">
            <div class="ftCon">
